...
- Used by: recommended ranking and freshness filters.
...
- Used by: recommended ranking, quality sort, quality filters.
...
- Formula: $recommended = 0.2\cdot quality + 0.5\cdot freshness + 0.3\cdot coverage$.
...
- Recommended/quality/attention sorts are computed in memory, but the signals themselves are fully deterministic and explained above.
