...
describe('island vector utilities', () => {
  ...
  it('keeps recency weights bounded and treats missing dates as current evidence', () => {
    expect(behaviorRecencyWeight(null)).toBe(1);
    expect(behaviorRecencyWeight(new Date(Date.now() + 86_400_000))).toBe(1);
    expect(behaviorRecencyWeight(new Date('2000-01-01T00:00:00.000Z'))).toBeGreaterThanOrEqual(0.2);
  });
