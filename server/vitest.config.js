...
const SEMANTIC_BASELINE_TEST = '/tests/semanticRegression.pipeline.test.js'; // This test is the baseline for semantic regression; it must only create the first set of events.
const CHECK_CREATE_TOPICS = '/tests/semanticRegression.createTopics.test.js'; // This test creates and checks topics after baseline events exist.
const CHECK_NO_ISLANDS = '/tests/semanticRegression.noIslands.test.js'; // Check that no islands exist after the topics are created
const CHECK_CREATE_ISLANDS = '/tests/semanticRegression.createIslands.test.js'; // This test builds and checks the islands.
const SEMANTIC_INCREMENTAL_TEST = '/tests/semanticRegression.incremental.pipeline.test.js'; // This test loads the next article wave and only creates or reuses events.
const SEMANTIC_INCREMENTAL_TOPICS_TEST = '/tests/semanticRegression.incremental.updateTopics.test.js'; // This test updates topics after the incremental event pass.
const SEMANTIC_INCREMENTAL_ISLANDS_TEST = '/tests/semanticRegression.incremental.updateIslands.test.js'; // This test updates islands after incremental topics.
const SEMANTIC_INCREMENTAL_UNREAD_TEST = '/tests/semanticRegression.incremental.unread.pipeline.test.js'; // This test adds more articles. It only creates events for the newly added articles.
