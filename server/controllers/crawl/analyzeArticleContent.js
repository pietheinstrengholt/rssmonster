...
async function analyzeArticleContent(contentStripped, title, categoryNames, RATE_LIMIT_DELAY_MS) {
  ...
  await new Promise(resolve => {
    ...
    const prompt = [
      ...
      "       • 100 = purely editorial and informational; no marketing or promotion",
      "       • 50  = mixed editorial and promotional content",
      "       • 0   = strongly promotional or marketing-driven",
      ...
      "       • 100 = neutral, calm, factual, or constructively positive tone",
      "       • 50  = mildly opinionated or emotionally charged but controlled",
      "       • 0   = strongly negative, alarmist, inflammatory, or fear-driven tone",
      "       • Decrease the score for:",
      ...
      "       • 100 = excellent clarity, strong structure, concise but complete",
      "       • 50  = average quality; readable but unremarkable or uneven",
      "       • 0   = poor quality; shallow, bloated, confusing, or misleading",
      "       • Decrease the score for:",
