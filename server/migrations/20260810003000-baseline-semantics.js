...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await addBaselineConstraint(queryInterface, "event_topics", {
      fields: ["eventId"],
      type: 'foreign key',
    ...
    await addBaselineConstraint(queryInterface, "events", {
    ...
    await addBaselineConstraint(queryInterface, "island_topics", {
      fields: ["islandId"],
      type: 'foreign key',
    ...
    await addBaselineConstraint(queryInterface, "islands", {
      fields: ["userId"],
      type: 'foreign key',
      name: "islands_ibfk_1",
      references: { table: "users", fields: ["id"] },
    ...
    await addBaselineConstraint(queryInterface, "topics", {
      fields: ["userId"],
      type: 'foreign key',
      name: "topics_ibfk_1",
      references: { table: "users", fields: ["id"] },
