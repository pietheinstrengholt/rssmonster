...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.addConstraint("hotlinks", {
      fields: ["userId"],
      type: 'foreign key',
