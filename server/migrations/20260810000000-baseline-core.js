...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.addConstraint("smart_folders", {
      fields: ["userId"],
      type: 'foreign key',
