...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await addBaselineConstraint(queryInterface, "feed_crawl_results", {
      fields: ["crawlRunId"],
      type: 'foreign key',
