...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await addBaselineConstraint(queryInterface, "feed_url_aliases", {
    ...
    await addBaselineConstraint(queryInterface, "feeds", {
    ...
    await addBaselineConstraint(queryInterface, "official_sources", {
      fields: ["userId"],
      type: 'foreign key',
