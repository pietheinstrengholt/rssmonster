...
<style scoped>
.actions-settings{max-width:1100px;color:var(--text-primary)}.actions-intro-card,.actions-list-section{background:var(--bg-primary);border:1px solid var(--border-subtle);border-radius:14px}.actions-intro-card{padding:26px;background:var(--settings-info-bg);border-color:var(--settings-info-border)}.actions-intro-heading,.actions-list-heading,.actions-note,.actions-order-note{display:flex;align-items:flex-start;gap:14px}.actions-intro-icon,.actions-type-icon,.actions-row-icon{display:inline-flex;align-items:center;justify-content:center;border-radius:10px}.actions-intro-icon{width:42px;height:42px;flex:0 0 42px;background:var(--bg-primary);color:var(--color-primary);font-size:20px}.actions-eyebrow{margin:0 0 4px;color:var(--color-primary);font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}.actions-intro-heading h3,.actions-list-heading h3{margin:0;color:var(--text-primary);font-size:20px;font-weight:700}.actions-intro-heading p:not(.actions-eyebrow),.actions-list-heading p,.actions-type-card p,.actions-field label,.actions-empty-state{color:var(--text-muted)}.actions-intro-heading p:not(.actions-eyebrow){max-width:720px;margin:6px 0 0;font-size:14px;line-height:1.5}.actions-type-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:24px}.actions-type-card{display:flex;gap:10px;padding:12px;background:var(--bg-primary);border:1px solid var(--border-subtle);border-radius:10px}.actions-type-icon,.actions-row-icon{width:34px;height:34px;flex:0 0 34px;background:var(--settings-neutral-bg);color:var(--settings-info-text);font-size:16px}.actions-type-icon--delete{background:var(--settings-danger-bg);color:var(--settings-danger-text)}.actions-type-icon--star{background:var(--settings-orange-bg);color:var(--settings-orange-text)}.actions-type-icon--read{background:var(--settings-success-bg);color:var(--settings-success-text)}.actions-type-icon--clicked{background:var(--settings-info-bg);color:var(--settings-info-text)}.actions-type-icon--advertisement{background:var(--settings-orange-bg);color:var(--settings-orange-text)}.actions-type-icon--badquality{background:var(--settings-danger-bg);color:var(--settings-danger-text)}.actions-type-icon--tag{background:var(--settings-rule-bg);color:var(--settings-rule-text)}.actions-type-card h4{margin:1px 0 3px;color:var(--text-primary);font-size:13px;font-weight:700}.actions-type-card p{margin:0;font-size:12px;line-height:1.4}.actions-note{margin-top:16px;padding-top:16px;border-top:1px solid var(--settings-info-border);color:var(--settings-info-text)}.actions-note p,.actions-order-note p{margin:0;font-size:13px;line-height:1.5}.actions-list-section{margin-top:24px;overflow:hidden}.actions-list-heading{align-items:center;justify-content:space-between;padding:22px 24px;border-bottom:1px solid var(--border-subtle)}.actions-list-heading p{margin:5px 0 0;font-size:13px}.actions-add-button,.actions-save-button,.actions-edit-button,.actions-delete-button{display:inline-flex;align-items:center;justify-content:center;border:0;cursor:pointer;font-weight:700}.actions-add-button{height:40px;gap:8px;padding:0 14px;background:var(--settings-orange-text);border-radius:8px;color:var(--text-inverted);font-size:14px}.actions-add-button:hover{background:var(--settings-orange-hover-text)}.actions-list-row{display:grid;grid-template-columns:18px 34px minmax(0,1fr) auto;gap:12px;align-items:center;padding:18px 24px}.actions-list-row+.actions-list-row{border-top:1px solid var(--border-subtle)}.actions-grip{color:var(--text-muted);font-size:18px}.actions-row-fields{display:grid;grid-template-columns:minmax(130px,.75fr) minmax(180px,1fr) minmax(220px,1.35fr);gap:12px;min-width:0}.actions-field label{display:block;margin-bottom:5px;font-size:12px;font-weight:700}.actions-field .form-control,.actions-field .form-select{height:38px;min-width:0;padding:6px 10px}.actions-type-control{display:flex;align-items:center;gap:6px}.actions-type-control .form-select{flex:1}.actions-type-pill{max-width:90px;overflow:hidden;padding:4px 7px;background:var(--settings-neutral-bg);border-radius:999px;color:var(--settings-neutral-text);font-size:11px;font-weight:700;text-overflow:ellipsis;white-space:nowrap}.actions-row-buttons{display:flex;gap:6px}.actions-edit-button{height:34px;gap:6px;padding:0 8px;background:var(--color-transparent);border-radius:6px;color:var(--settings-orange-text);font-size:13px}.actions-edit-button:hover{background:var(--settings-orange-bg);color:var(--settings-orange-text)}:global(:root[data-theme='dark']) .actions-edit-button:hover{background:var(--settings-orange-bg);color:var(--settings-orange-text)}.actions-delete-button{width:34px;height:34px;background:var(--settings-danger-bg);border-radius:6px;color:var(--settings-danger-text);font-size:14px}.actions-empty-state{margin:0;padding:36px 24px;text-align:center}.actions-order-note{margin:0;padding:16px 24px;background:var(--settings-neutral-bg);border-top:1px solid var(--border-subtle);color:var(--text-secondary)}.actions-save-area{display:flex;justify-content:flex-end;margin-top:20px}.actions-save-button{height:42px;gap:8px;padding:0 16px;background:var(--color-primary);border-radius:8px;color:var(--text-inverted);font-size:14px}.actions-save-button:hover{background:var(--color-primary-hover)}:global(:root[data-theme='dark']) .actions-add-button{background:var(--settings-orange-bg);color:var(--settings-orange-text);border:1px solid var(--settings-orange-border)}:global(:root[data-theme='dark']) .actions-add-button:hover{background:var(--settings-orange-bg);color:var(--settings-orange-text)}:global(:root[data-theme='dark']) .actions-intro-card,:global(:root[data-theme='dark']) .actions-list-section,:global(:root[data-theme='dark']) .actions-type-card{background:var(--bg-modal);border-color:var(--border-color)}:global(:root[data-theme='dark']) .actions-list-heading,:global(:root[data-theme='dark']) .actions-list-row+.actions-list-row,:global(:root[data-theme='dark']) .actions-order-note,:global(:root[data-theme='dark']) .actions-note{border-color:var(--border-color)}:global(:root[data-theme='dark']) .actions-order-note{background:var(--bg-control)}@media(max-width:900px){.actions-row-fields{grid-template-columns:repeat(2,minmax(0,1fr))}.actions-field--regex{grid-column:1/-1}}@media(max-width:766px){.actions-intro-card{padding:20px}.actions-type-grid{grid-template-columns:1fr}.actions-list-heading{flex-direction:column;padding:20px}.actions-list-row{grid-template-columns:18px 34px minmax(0,1fr);padding:18px 20px}.actions-row-fields,.actions-field--regex{grid-column:1/-1;grid-template-columns:1fr}.actions-row-buttons{grid-column:3;justify-content:flex-end}}
</style>
