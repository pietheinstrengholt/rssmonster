<template>
  <div class="article-meta">
    ...
    <span v-if="!isEventArticle && event && eventArticleCountTotal > 1 && grouping !== 'none'" class="similar-badge" @click.stop="$emit('view-event-articles', event.id)">+{{ eventArticleCountTotal - 1 }} similar article{{ eventArticleCountTotal - 1 === 1 ? '' : 's' }}</span>
